...
<div class="row">
	<div class="col-sm-6">
		<a id="cancel-project-restore" class="btn btn-primary btn-block btn-sm" href="#">Cancel</a>
	</div>
	<div class="col-sm-6">
		<a id="confirm-project-restore" class="btn btn-danger btn-block btn-sm" href="#">Confirm</a>
	</div>
</div>